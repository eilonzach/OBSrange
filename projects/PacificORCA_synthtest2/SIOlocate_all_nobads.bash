...
for i in *_nobads.txt
do 
	sta=`echo $i | sed s/_nobads.txt//g`
	if echo $i | grep -q "orrected_nobads" 
		then
			echo " "
		else
			echo "================================================="
			...
			python $locator_code_path Y 1500 $survey_file_dir/$i $slat $slon $sdep "$sta"_SIOcorrected_nobads.txt
