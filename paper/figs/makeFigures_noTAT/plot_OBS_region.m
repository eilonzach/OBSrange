...
vi_sum = 0;
hi_sum = 0;
for ifil = 1:length(fils) %1:length(fils)-6 %[1 8]
...
% contourf(LONi,LATi,sqrt(vi_mean.^2+ui_mean.^2),20,'linestyle','none'); hold on;
quiver(LONi,LATi,vi_mean*scale,ui_mean*scale,'k','filled','AutoScale','off','linewidth',1);% hold on;
% annotation('textbox',[0.6 0.11 0.2 0.09],'String','50 cm/s','BackgroundColor','w');
% t = quiver(-130.5+360,-8.5,-0.5*scale,0,'k','filled','AutoScale','off','linewidth',2);
% plot(-130.5+360,-8.5,t.UData,t.VData,'k','linewidth',2);
